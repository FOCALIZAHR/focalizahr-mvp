...
// fixed inset-0 z-50, Tesla line amber (findings = warning)
    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          className="relative bg-[#0F172A]/95 backdrop-blur-2xl border border-slate-800 rounded-2xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-hidden flex flex-col"
        >
          {/* Tesla line amber */}
          <div
