    ...
    return (
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        >
          ...
          <h1 className="text-2xl font-light text-green-400 mb-2">
            Evaluación Completada
          </h1>
          <p className="text-slate-300 mb-4">
            Has completado la evaluación de {assignment.evaluatee.fullName}
          </p>

          {/* Info del evaluado */}
          <div className="bg-slate-800/50 rounded-lg p-4 mt-6 text-left">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">
                  {assignment.evaluatee.position || 'Sin cargo'} · {assignment.evaluatee.departmentName}
                </p>
              </div>
            </div>
          </div>
