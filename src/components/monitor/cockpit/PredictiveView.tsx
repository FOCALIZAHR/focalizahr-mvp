...
export function PredictiveHeader({
  ...
  return (
    <div className="bg-slate-900/50 p-6 sm:p-8 rounded-2xl border border-slate-700/50 relative overflow-hidden intelligence-flow">
      ...
      <h1 className="fhr-title-gradient text-xl lg:text-2xl font-bold mb-6 text-center lg:text-left">
        {campaignName}
      </h1>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-8 h-full">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center justify-center">
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
              ...
              <p className="fhr-text-accent text-xs font-mono mt-1">{confidenceHero}% confianza</p>
            </div>
          </motion.div>
        ...
        <div className="w-full lg:w-1/2 lg:max-w-sm space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xl font-semibold text-white">
                    <span className="font-mono">{participationPrediction?.velocity?.toFixed(1) ?? 'N/A'}</span> 
                    <span className="text-sm text-slate-400">resp/día</span>
                  </p>
                  <p className="text-sm font-semibold" style={{ color: trend.colorVar }}>
                    {trend.text}
                  </p>
                </div>
          ...
          >
            ...
            >
              <p className="text-lg font-semibold text-white mb-1">{actionToDisplay.primary}</p>
          ...
          >
            ...
            >
              <p className="text-lg text-slate-300">
                Proyección final: <span className="font-semibold text-white">{projectionHero.toFixed(1)}%</span>
              </p>
