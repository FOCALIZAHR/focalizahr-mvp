// ====================================================================
// EXIT TABS TOGGLE - RESPONSIVE MOBILE + DESKTOP
// src/components/exit/ExitTabsToggle.tsx
// Filosofia: Estilo Tesla/Apple con soporte movil completo
// Copiado de OnboardingTabsToggle.tsx
// ====================================================================
...
const TABS: TabConfig[] = [
  ...
  { value: 'alertas', label: 'Alertas Criticas', icon: AlertCircle, color: 'purple' },
  { value: 'enps', label: 'eNPS Exit', icon: BarChart3, color: 'purple' }
];

export default function ExitTabsToggle({
  activeTab,
  onTabChange,
  isTransitioning = false
}: ExitTabsToggleProps) {

  // Calcular posicion del slider segun tab activo
  ...
  // Determinar color del slider segun tab activo
  ...
  return (
    <div className="w-full flex justify-center mb-8 px-2 sm:px-4">
      ...
      >
        ...
        {/* SLIDER INDICATOR CON GRADIENTE DINAMICO */}
        <motion.div
