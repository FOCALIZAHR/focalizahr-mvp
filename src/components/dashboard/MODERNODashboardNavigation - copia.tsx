      ...
      <div className="hidden lg:flex lg:w-64 lg:flex-col lg:fixed lg:inset-y-0 lg:z-50">
        ...
        >
          ...
          <div 
            ...
            style={{
              background: 'linear-gradient(135deg, #22D3EE 0%, #A78BFA 50%, #3B82F6 100%)',
              zIndex: 0
            }}
          />
              ...
              <div className="px-6 py-4 border-b border-white/10">
                <div className="flex items-center">
                  ...
                  <div className="ml-3 flex-1">
                    <p className="text-sm font-semibold text-white">{user.companyName || 'Empresa Demo'}</p>
                    <p className="text-xs text-muted-foreground">{user.adminName || 'Admin Demo'}</p>
                    <p className="text-xs text-cyan-400 font-medium">FocalizaHR</p>
                  </div>
                  <Button
                    variant="ghost"
                    size="sm"
            ...
            <div className="px-4 py-4 border-t border-white/10">
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <span className="text-xs font-semibold text-white/80">Sistema</span>
